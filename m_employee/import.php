	...
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb">
			<li>
				...
				<i class="fa fa-circle"></i>Import Employee Existing
			</li>
		</ul>
		<!-- END PAGE BREADCRUMB -->
				...
				<div class="portlet box green-sharp">
					<div class="portlet-title">
						<div class="caption font-light">
							...
							<span class="caption-subject bold"> Import Employee Existing </span>
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="<?=base_url();?>m_employee/upload" class="form-horizontal" enctype="multipart/form-data" method="POST">
							<div class="form-body">
...
<script type="text/javascript">
	...
	function template() {
		...
		$.redirectPost('<?=base_url();?>m_employee/get_template', {});
